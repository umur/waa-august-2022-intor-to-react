...
insert into public.user (id, email, first_name, last_name, password)
values  (1, 'admin@gmail.com', 'admin', 'admin', '12345'),
        (2, 'user1@gmail.com', 'user1', 'user 1', '12345'),
        (3, 'user2@gmail.com', 'user2', 'user 1', '12345');
